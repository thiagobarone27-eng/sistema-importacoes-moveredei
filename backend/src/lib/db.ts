...
export interface ImportacaoTable {
  ...
  airFreight: Generated<number>;
  desconsolidacao: Generated<number>;
  taxaLiberacao: Generated<number>;
  docFeeOrigin: Generated<number>;
  customsOrigin: Generated<number>;
  pickUp: Generated<number>;
  palletFee: Generated<number>;
  exportLicense: Generated<number>;
  devolucaoVazio: Generated<number>;
  lavagem: Generated<number>;
  fichaEmergencia: Generated<number>;
  impostosFederais: Generated<number>;
  afrmm: Generated<number>;
  honorarios: Generated<number>;
  licenciamento: Generated<number>;
